...
function onOpen() {
  ...
  var ui2 = SpreadsheetApp.getUi();
    ui2.createMenu('Sales')
      .addItem('Daily Sales Email', 'salesEmail')
      .addSeparator()
      .addItem('Backup Data', 'backupData')
      .addSeparator()
      .addSubMenu(ui.createMenu('Update Sales')
        .addItem('Elevate', 'updateElevateSale')
        .addSeparator()
        .addItem('Rise', 'updateRiseSale')
        .addSeparator()
        .addItem('Ascend', 'updateAscendSale')
        .addSeparator()
        .addItem('Breathe', 'updateBreatheSale')
        .addSeparator()
        .addItem('SAF', 'updateSAFSale')
        .addSeparator()
        .addItem('AT', 'updateATSale')
        .addSeparator()
        .addItem('Alpha', 'updateAlphaSale')
        .addSeparator()
        .addItem('Breakthrough', 'updateBreakthroughSale')
        .addSeparator()
        .addItem('CIC', 'updateCICSale')
        .addSeparator()
        .addItem('Edge', 'updateEdgeSale')
        .addSeparator()
        .addItem('Elevate Ads', 'updateAdSale'))
        .addToUi();

  var ui3 = SpreadsheetApp.getUi();
    ui3.createMenu('Charts')
      .addItem('Total Rev By Product', 'addChart')
      .addToUi();
